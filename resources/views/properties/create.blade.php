    ...
    <form action="/properties" method="POST">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="propertyNo" class="w-full border rounded px-3 py-2" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="rooms" class="w-full border rounded px-3 py-2" required>
            </div>
            ...
            <div>
                ...
                <input type="date" name="withdrawDate" class="w-full border rounded px-3 py-2">
            </div>
        </div>

        <div class="mt-4 flex gap-3">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Save Property</button>
